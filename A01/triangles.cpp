...
Triangle(-0.05, 0.19, 0.35, -0.5, 0.80, 0.19, 1, 0, 0);	// Rooftop

// Half of the house
Triangle(0.05, 0.19, 0.05, 0.80, 0.35, 0.5, 0, 0, 1);
Triangle(0.05, 0.19, 0.35, 0.19, 0.35, 0.5, 0, 0, 1);
Triangle(0.35, 0.80, 0.05, 0.80, 0.35, 0.5, 0, 0, 1);

// Half of the house
Triangle(0.70, 0.19, 0.70, 0.80, 0.35, 0.5, 0, 0, 1);
Triangle(0.35, 0.19, 0.35, 0.5, 0.70, 0.19, 0, 0, 1);
Triangle(0.35, 0.80, 0.70, 0.80, 0.35, 0.5, 0, 0, 1);
...
// Door
Triangle(0.3, 0.8, 0.45, 0.8, 0.3, 0.5, 1, 1, 0);
Triangle(0.45, 0.8, 0.45, 0.5, 0.3, 0.5, 1, 1, 0);


// Windows
Triangle(0.17, 0.27, 0.17, 0.42, 0.27, 0.42, 1, 1, 0);
Triangle(0.17, 0.27, 0.27, 0.27, 0.27, 0.42, 1, 1, 0);

Triangle(0.47, 0.27, 0.47, 0.42, 0.57, 0.42, 1, 1, 0);
Triangle(0.47, 0.27, 0.57, 0.27, 0.57, 0.42, 1, 1, 0);


for(int i = 0; i < 32; i++) {
	Triangle( 0.75 + 0.05 * cos(6.28/32*(i-0.5)), -0.80 + 0.05 * sin(6.28/32*(i-0.5)),
			  0.75 + 0.10 * cos(6.28/32*i), -0.80 + 0.10 * sin(6.28/32*i),
			  0.75 + 0.05 * cos(6.28/32*(i+0.5)), -0.80 + 0.05 * sin(6.28/32*(i+0.5)),
			  1,1,0);
}
